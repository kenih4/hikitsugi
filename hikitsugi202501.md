...
- [ ] 9/24 CB13-3 KLY交換 -> 通常タイプに戻ったので充電電圧を上げないといけない　
...
- 不具合箇所：
  ...
  - LB 集束コイルの流量低のアラーム発報（以前から発生する偽発報） 流量計本体＋センサー部の交換を実施している- が、再発
...
- [ ] 9/30 ID アラーム　ホスト'id40rt' 以下にあるデータが取得できず。
