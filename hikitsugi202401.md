...
- [x] 6/5 LB サイラトロングリッド残留電圧が変動した。この変動により BL2利用中のFELが一時的に低下 
...
- [ ] 5/19 アボート　Bstポンプ停止 閾値緩めた、ジャンパーしてRF電源室 Bst パネルメーターの背面端子にデータロガーを接続  5/26現象捉えた
- [ ] 5/20 マシン調整
・「空洞のHOMの観測と不安定性の確認」
