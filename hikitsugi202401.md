...
- [ ] 4/1 立上げ　テストスタンドにおいてINV試験中配線ミス広範囲に落ちる 安全高速停止モジュールリセット
- [x] 4/2 238 Amp DC OFFしないでVMEリブートしてバランス崩れる
- [x] 4/5 ML_INJ_GUNでは、感度が停止前ほどなかった為
ML_INJ_GUN_0で476_MSBPMのchargeを調整
地絡の影響か？　ML FBに使用しているMLの感度が停止前と違う為、ML_INJ_GUN_0でFBを使用
- [x] 4/5 ダブルパルススタディ
- [x] 4/6 光軸調整 BL3途中で2A入ったり、高さスキャン平になったり、高さ前回と数百um異なったりで没
- [x] 4/6 CB07-4 Inverter Tank
